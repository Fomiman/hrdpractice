...
<script type="text/javascript" src="./javaScript/check.js">
	//유효성 체크
	/* function check() {
		if(!f.custno.value) {
...
<body>
	...
	<section>
		...
		<input type="hidden" name="pro1" value="" >
			...
			<table width="600" border="1">
				...
				<tr>
					<th colspan="2">
						<input type="submit" value="수정_함께-1" onclick="updateCheck(); return false;">
						<input type="submit" value="삭제_함께-1" onclick="deleteCheck();">
						
						<!-- this : button객체, this.id : button객체의 id (id로 버튼을 구분함) -->
						<button type="button" name="btn" id="update" onclick="updateDeleteCheck(this.id);">수정_함께-2</button>
						<button type="button" name="btn" id="delete" onclick="updateDeleteCheck(this.id);">삭제_함께-2</button>
